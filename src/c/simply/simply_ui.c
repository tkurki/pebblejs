...
static SimplyStyle STYLES[StyleIndexCount];
...
void initialize_styles(void) {
  ...
  STYLES[StyleIndex_Large] = (SimplyStyle){
    .title_icon_padding = 4,
    .title_font = FONT_KEY_GOTHIC_18_BOLD,
    .title_padding = 3,
